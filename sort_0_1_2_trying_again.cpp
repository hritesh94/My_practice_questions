...
int main() {
    ...
    while(left<middle<right)
        ...
        //
         if(arr[left]=2 && arr[right]==0 && left<middle<right)
            {
               swap(arr[left],arr[right]); 
            }
         if(arr[left]==1 && arr[middle]==0 && left<middle<right)
            {
                swap(arr[left],arr[middle]);
            }
         if(arr[right]==1 && arr[middle]==2 && left<middle<right)
            {
                swap(arr[middle],arr[right]);
            }
         if(arr[left]==1 && arr[middle]==2 && arr[right]==0 && left<middle<right)
            {
                swap(arr[middle],arr[right]);
                swap(arr[left],arr[middle]);
            }
         if(arr[left]==2 && arr[middle]==0 && arr[right]==1 && left<middle<right)
            {
                swap(arr[left],arr[middle]);
                swap(arr[middle],arr[right]);
            }
